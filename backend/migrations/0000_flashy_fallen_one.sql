...
CREATE TABLE "patients" (
	...
	"patient_class" "patient_class" NOT NULL,
...
CREATE MATERIALIZED VIEW "public"."staff_performance" AS (select "staff"."id" as "staff_id", "staff"."code" as "staff_code", "staff"."name" as "staff_name", "staff"."loket_number" as "loket_number", "clinics"."name" as "clinic_name", COUNT("queues"."id") as "total_served", 
